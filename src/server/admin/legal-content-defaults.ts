...
const FR_DEFAULTS: Record<LegalContentKey, string> = {
  ...
  landing_faq_stations: qa([
    ...
    { q: 'Comment recevoir mes paiements ?', a: 'Connectez votre compte Stripe depuis Configuration → Paiements. Stripe est notre partenaire de paiement sécurisé. Les fonds sont automatiquement reversés chaque semaine sur votre compte bancaire lié.' },
    { q: 'Que faire en cas d\'absence client (no-show) ?', a: 'Si un client ne se présente pas à son rendez-vous, vous pouvez signaler l\'absence depuis votre tableau de bord. Des frais de no-show s\'appliquent automatiquement selon la politique en vigueur. Le créneau est alors libéré pour d\'autres clients.' },
    { q: 'Comment gérer les litiges avec un client ?', a: 'En cas de désaccord, contactez d\'abord le client pour trouver une solution. Si aucun accord n\'est trouvé, ouvrez un litige depuis votre tableau de bord. L\'équipe Hurryline intervient en médiateur et sa décision est définitive pour les litiges inférieurs à 500 $ CAD.' },
    { q: 'Puis-je modifier ou annuler une réservation ?', a: 'Oui, vous pouvez annuler une réservation depuis votre tableau de bord. Toute annulation après confirmation entraîne le remboursement intégral du client. Un taux d\'annulation élevé peut entraîner une suspension temporaire de votre compte.' },
    { q: 'Comment ajouter des services ou forfaits ?', a: 'Accédez à l\'onglet Services depuis votre tableau de bord. Vous pouvez créer des forfaits avec différents formats de véhicules, durées et prix. Chaque service peut être activé ou désactivé à tout moment.' },
    { q: 'Comment télécharger les QR codes de ma station ?', a: 'Depuis votre tableau de bord, allez dans Promotion → QR Code. Vous pouvez générer et télécharger des affiches QR code personnalisées au nom de votre station pour permettre aux clients de réserver directement.' },
  ]),
  ...
  landing_guide_station: [
    ...
    '<li><strong>Documents</strong> — Téléchargez votre certificat d\'immatriculation, justificatif d\'adresse et permis d\'exploitation</li>',
    '</ul>',
    '<p>Notre équipe examine votre dossier sous 48 h ouvrées. Vous recevrez un e-mail de confirmation dès votre compte validé.</p>',
    '<h2>Étape 2 — Ajoutez les photos de votre station</h2>',
    '<p>Des photos de qualité rassurent les clients et augmentent vos réservations. Depuis votre tableau de bord, accédez à Configuration → Photos pour ajouter :</p>',
    '<ul>',
    '<li>Une photo de façade de votre station</li>',
    '<li>Des photos de vos postes de lavage</li>',
    '<li>Des photos des équipements et services proposés</li>',
    '</ul>',
    '<p>Formats acceptés : JPG, PNG, WebP. Taille maximale : 10 Mo par image.</p>',
    '<h2>Étape 3 — Définissez vos horaires d\'ouverture</h2>',
    '<p>Dans Configuration → Horaires, définissez vos plages horaires pour chaque jour de la semaine. Vous pouvez :</p>',
    '<ul>',
    '<li>Définir une heure d\'ouverture et de fermeture par jour</li>',
    '<li>Fermer certains jours (ex. dimanche)</li>',
    '<li>Ajuster les horaires selon les saisons</li>',
    '</ul>',
    '<p>Les clients verront uniquement les créneaux disponibles dans vos plages horaires.</p>',
    '<h2>Étape 4 — Configurez vos postes et services</h2>',
    '<p>Depuis l\'onglet Postes de lavage, indiquez le nombre de postes disponibles et leurs caractéristiques. Ensuite, créez vos services et forfaits :</p>',
    '<ul>',
    '<li>Définissez les formats de véhicules acceptés (berline, SUV, fourgonnette, etc.)</li>',
    '<li>Fixez vos prix par format et par type de lavage</li>',
    '<li>Indiquez la durée estimée pour chaque service</li>',
    '</ul>',
    '<p>Ces informations permettent aux clients de choisir le service adapté à leur véhicule et de réserver le bon créneau.</p>',
    '<h2>Étape 5 — Connectez votre compte Stripe</h2>',
    '<p>Pour recevoir vos paiements, connectez un compte Stripe depuis Configuration → Paiements. Stripe est notre partenaire de paiement sécurisé. Le processus est simple :</p>',
    '<ul>',
    '<li>Cliquez sur « Connecter avec Stripe »</li>',
    '<li>Suivez les étapes de vérification Stripe (identité, coordonnées bancaires)</li>',
    '<li>Une fois connecté, les fonds sont automatiquement reversés chaque semaine</li>',
    '</ul>',
    '<p>Les clients paient au moment de la réservation. Vous recevez le montant net (prix moins commission Hurryline) directement sur votre compte bancaire.</p>',
    '<h2>Étape 6 — Gérez vos disponibilités</h2>',
    '<p>Votre calendrier de disponibilités vous permet de contrôler finement les créneaux proposés aux clients :</p>',
    '<ul>',
    '<li>Visualisez les réservations à venir dans un calendrier mensuel</li>',
    '<li>Bloquez manuellement des créneaux pour maintenance ou fermeture exceptionnelle</li>',
    '<li>Consultez les statistiques de votre station (taux d\'occupation, revenus)</li>',
    '</ul>',
    '<h2>Étape 7 — Lancez-vous !</h2>',
    '<p>Une fois toutes les étapes complétées, votre station est visible sur la plateforme. Les clients peuvent :</p>',
    '<ul>',
    '<li>Rechercher votre station près de chez eux</li>',
    '<li>Consulter vos services et tarifs</li>',
    '<li>Réserver un créneau en ligne et payer à l\'avance</li>',
    '</ul>',
    '<p>Vous pouvez suivre votre activité en temps réel depuis votre tableau de bord : réservations du jour, revenus, avis clients, et plus encore.</p>',
    '<p>Besoin d\'aide ? Consultez notre <a href="/faq-stations">FAQ marchands</a> ou <a href="/nous-contacter">contactez notre équipe</a>.</p>',
  ].join('\n'),
