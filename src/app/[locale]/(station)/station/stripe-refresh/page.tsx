...
export default function StripeRefreshPage() {
      ...
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#F7F6F2] px-4 dark:bg-[#0C1209]">
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-[#E8E4DC] bg-white p-8 shadow-sm dark:border-[#1A2A14] dark:bg-[#182214]">
          ...
          <a
            ...
            className="mt-1 rounded-xl bg-[#DDAF3B] px-5 py-2.5 text-[13px] font-bold text-[#0C1209] hover:opacity-90"
          >
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#F7F6F2] px-4 dark:bg-[#0C1209]">
      <div className="flex flex-col items-center gap-3 rounded-2xl border border-[#E8E4DC] bg-white p-8 shadow-sm dark:border-[#1A2A14] dark:bg-[#182214]">
        <div className="h-8 w-8 animate-spin rounded-full border-2 border-[#E8E4DC] border-t-[#DDAF3B] dark:border-[#001A05] dark:border-t-[#DDAF3B]" aria-hidden="true" />
