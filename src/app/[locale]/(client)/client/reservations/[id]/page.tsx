        ...
        {isUpcoming && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl text-[15px] font-black text-center transition-all flex items-center justify-center gap-2 bg-gold hover:bg-gold-hover text-dark-bg cursor-pointer"
            >
