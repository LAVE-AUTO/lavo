        ...
        <Section>
          ...
          <div className="divide-y divide-[rgba(221,175,59,0.08)]">
            {[
              ...
              { href: '/politique-de-confidentialite', label: t('help_privacy'), icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
            ].map(({ href, label, icon }) => (
              <Link
                key={label}
