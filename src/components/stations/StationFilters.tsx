        ...
        <div className="scrollbar-hover flex-1 overflow-y-auto px-5 sm:px-6 py-5 space-y-5">
          ...
          <FilterRow label={t('filter_date_label')}>
            <input
              ...
              onChange={(e) => patch({ date: e.target.value })}
              aria-label={t('filter_date_label')}
              className="w-full rounded-xl border border-[#E0E0D0] bg-[#F5F5EE] px-3 py-2.5 font-mono text-[14px] text-[#1A1A1A] outline-none focus:border-gold dark:border-tab-inactive dark:bg-tab-inactive dark:text-white transition-colors"
            />
          </FilterRow>
