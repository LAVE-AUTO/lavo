    ...
    <>
      <div className="flex flex-col gap-4 px-6 py-5">
              ...
              <button key={r} type="button" onClick={() => onRoleChange(r)}
                className={[
                  ...
                  role === r
                    ...
                    : 'text-foreground/55 hover:text-foreground/70 dark:text-[#B0BFB1] dark:hover:text-[#B0BFB1]',
                ].join(' ')}>
                {t(`role_${r}`)}
              </button>
            ))}
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="add-user-firstname" className="text-[13px] font-bold text-foreground/70 dark:text-[#B0BFB1]">{t('field_firstname')}</label>
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="add-user-lastname" className="text-[13px] font-bold text-foreground/70 dark:text-[#B0BFB1]">{t('field_lastname')}</label>
        ...
        {/* Email */}
        <div className="flex flex-col gap-1.5">
          <label htmlFor="add-user-email" className="text-[13px] font-bold text-foreground/70 dark:text-[#B0BFB1]">{t('field_email')}</label>
        ...
        <div className="flex items-start gap-2 rounded-lg bg-[#F5F3EE] px-3 py-2.5 dark:bg-[#131E10]">
          ...
          <p className="text-[12px] leading-snug text-foreground/65 dark:text-[#B0BFB1]">{t('form_password_notice')}</p>
        </div>
