...
export function AdminEditUserModal({ open, user, onClose, onSaved }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[480px] animate-fade-in-up overflow-hidden rounded-2xl border border-separator/30 bg-card-surface shadow-2xl dark:border-[#1E2E18] dark:bg-dark-bg">
