    ...
    <>
      <div className="flex flex-col gap-3 overflow-y-auto px-6 py-5" style={{ maxHeight: '60vh' }}>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          {errors.stationName && <p className="text-[12px] font-semibold text-red-500">{errors.stationName}</p>}
        </div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {errors.washPostCount && <p className="text-[12px] font-semibold text-red-500">{errors.washPostCount}</p>}
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          {errors.washTypeCodes && <p className="text-[12px] font-semibold text-red-500">{errors.washTypeCodes}</p>}
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <span className={`absolute bottom-2 right-2 text-[11px] tabular-nums ${data.description.length >= 900 ? 'text-red-400' : 'text-[#BBBBAA]'}`}>
      ...
      <div className="flex justify-end gap-2 border-t border-[#F0EDE6] px-6 py-4 dark:border-[#1A2A14]">
        ...
        <button type="button" onClick={onNext} disabled={busy}
          className="rounded-lg bg-[#DDAF3B] px-4 py-2 text-[13px] font-bold text-[#0C1209] transition-colors hover:bg-[#B08A14] disabled:opacity-50">
          {t('btn_next')}
        </button>
      </div>
    </>
