  ...
  return (
    <>
      <div className="flex flex-col items-start gap-5 px-6 py-5">
        ...
        <div className="flex w-full gap-2.5 rounded-xl border border-[#DDAF3B]/20 bg-[#DDAF3B]/6 px-4 py-3.5">
          ...
          <div className="flex flex-col gap-0.5">
            <p className="text-[13px] font-bold text-[#001201] dark:text-[#FFF9EC]">{t('success_kyc_notice_title')}</p>
            <p className="text-[12px] leading-relaxed text-foreground/70 dark:text-[#A0A090]">
      ...
      <div className="flex justify-end border-t border-[#F0EDE6] px-6 py-4 dark:border-[#1A2A14]">
        <button type="button" onClick={onClose}
          className="rounded-lg bg-[#DDAF3B] px-4 py-2 text-[13px] font-bold text-[#0C1209] transition-colors hover:bg-[#B08A14]">
          {t('btn_close')}
        </button>
      </div>
    </>
