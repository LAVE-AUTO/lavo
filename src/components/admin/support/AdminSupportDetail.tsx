    ...
    <>
      ...
      <div className="flex min-h-full flex-col">
        ...
        <div className="shrink-0 border-b border-[#E0DCD0] bg-[#F5F5EE] px-6 pb-5 pt-5 dark:border-[#1A2A14] dark:bg-[#0C1209]">
          <Link href="/admin/support" className="mb-4 flex w-fit items-center gap-1.5 text-[12px] font-semibold text-[#888] transition-colors hover:text-[#C49A1E] dark:text-[#9A9A8A]">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="mt-1.5 text-[12px] text-[#888] dark:text-[#9A9A8A]">
        ...
        <div className="flex-1 overflow-y-auto bg-[#F5F5EE] p-6 dark:bg-[#0C1209]">
          <div className="mx-auto flex max-w-2xl flex-col gap-5">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-[11px] font-black uppercase tracking-wider text-[#AAAAAA] dark:text-[#A0A090]">{t('section_thread')}</h2>
                  ...
                  return (
                    <div key={msg.id} className={`flex gap-3 ${isAdmin ? 'flex-row-reverse' : ''}`}>
                      ...
                      <div className={[
                        ...
                        <p className={`mb-1 text-[11px] font-black tracking-wide ${isAdmin ? 'text-[#C49A1E]/90' : 'text-[#888] dark:text-[#9A9A8A]'}`}>
                          {msg.author}
                        </p>
                        <p className="text-[13px] leading-relaxed text-[#1A1A0A] dark:text-[#F0EDD4]">{msg.body}</p>
                        <p className="mt-1.5 text-[10px] text-[#BBBBAA] dark:text-[#A0A090]">{formatDateTime(msg.created_at)}</p>
                      </div>
                    </div>
                  );
                })
              ...
              <div className="rounded-2xl border border-[#E8E4DC] bg-white shadow-sm dark:border-[#1E2E18] dark:bg-[#131E10]">
                ...
                <form onSubmit={handleSendReply} className="flex flex-col gap-3 p-5">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] text-[#BBBBAA] dark:text-[#A0A090]">{reply.length}/2000</span>
            ...
            {isResolved && (
              <div className="flex items-center justify-center rounded-2xl border border-[#E8E4DC] bg-white px-5 py-4 shadow-sm dark:border-[#1E2E18] dark:bg-[#131E10]">
                <p className="text-[12px] text-[#AAAAAA] dark:text-[#A0A090]">{t('status_resolved_notice')}</p>
              </div>
            )}
            ...
            {isClosed && (
              <div className="flex items-center justify-center rounded-2xl border border-[#E8E4DC] bg-white px-5 py-4 shadow-sm dark:border-[#1E2E18] dark:bg-[#131E10]">
                <p className="text-[12px] text-[#AAAAAA] dark:text-[#A0A090]">{t('close_success')}</p>
              </div>
            )}
          </div>
        </div>
