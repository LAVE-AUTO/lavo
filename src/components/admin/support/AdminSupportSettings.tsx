    ...
    <form onSubmit={handleSave} className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-black/[0.04] dark:bg-[#1A2416] dark:ring-white/[0.06]">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="support-email" className="text-[11px] font-black uppercase tracking-wider text-[#8A8A7A] dark:text-[#6A6A5A]">{t('settings_email_label')}</label>
        ...
        {/* Max open tickets */}
        <div className="flex flex-col gap-1.5">
          <label htmlFor="max-tickets" className="text-[11px] font-black uppercase tracking-wider text-[#8A8A7A] dark:text-[#6A6A5A]">{t('settings_max_tickets_label')}</label>
        ...
        {/* Auto close days */}
        <div className="flex flex-col gap-1.5">
          <label htmlFor="auto-close" className="text-[11px] font-black uppercase tracking-wider text-[#8A8A7A] dark:text-[#6A6A5A]">{t('settings_auto_close_label')}</label>
        ...
        <div className="flex flex-col gap-1.5 sm:col-span-2">
          <label htmlFor="welcome-msg" className="text-[11px] font-black uppercase tracking-wider text-[#8A8A7A] dark:text-[#6A6A5A]">{t('settings_welcome_label')}</label>
