      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={panelRef}>
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -right-1 -top-1 min-w-[18px] h-[18px] rounded-full bg-Hurryline-error px-1 text-center text-[10px] font-black leading-[18px] text-white shadow-sm ring-2 ring-[#EEE9D8] dark:ring-[#182214]">
