        ...
        return (
          <div key={client.id}
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-[11px] text-[#BBBBAA] dark:text-[#A0A090]">{formatDate(client.created_at)}</p>
            </div>

            <div className="min-w-0">
              <p className="truncate text-[12px] text-[#555] dark:text-[#9A9A8A]">{client.email}</p>
              <p className="truncate text-[11px] text-[#BBBBAA] dark:text-[#A0A090]">{client.phone}</p>
            </div>
