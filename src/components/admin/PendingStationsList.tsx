      ...
      <div className="flex min-w-0 flex-1 items-center gap-4 px-5 py-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2">
            {/* Date */}
            <span className="flex items-center gap-1 text-[10px] font-semibold text-[#999] dark:text-[#8A8A7A]">
            ...
            {/* Separator */}
            {isPending && docCount > 0 && <span className="text-[#DDD] dark:text-[#6A6A5A]">·</span>}
            ...
            {s.rejection_count > 0 && (
              <>
                <span className="text-[#DDD] dark:text-[#6A6A5A]">·</span>
        ...
        <div className="relative overflow-hidden px-7 pt-6 pb-0">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-0.5 text-[11px] text-[#AAA] dark:text-[#8A8A7A]">
