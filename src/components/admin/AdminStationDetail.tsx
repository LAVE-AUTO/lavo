    ...
    <div className="flex flex-1 flex-col overflow-hidden bg-[#F5F5EE] dark:bg-[#0C1209]">
      ...
      <div className="flex items-center gap-4 border-b border-[#E8E4D8] bg-white px-7 py-4 dark:border-[#1A2A14] dark:bg-[#111A0E]">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-[11px] text-[#999] dark:text-[#A0A090]">{station.city}</p>
        </div>
      ...
      <div className="flex flex-1 flex-col gap-5 overflow-y-auto px-7 py-6">
        ...
        <div className="relative rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/[0.04] dark:bg-[#1A2416] dark:ring-white/[0.06]">
          ...
          <div className="flex items-start gap-5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-0.5 text-[12px] text-[#888] dark:text-[#9A9A8A]">
                {station.city}{station.address ? ` · ${station.address}` : ''}
              </p>
              <div className="mt-3 flex flex-wrap items-center gap-2">
                {/* Date badge */}
                <span className="flex items-center gap-1.5 rounded-lg bg-[#F5F3ED] px-2.5 py-1 text-[11px] font-semibold text-[#777] dark:bg-[#1E2A1A] dark:text-[#9A9A8A]">
                ...
                {/* KYC status badge */}
                <span className="flex items-center gap-1.5 rounded-lg bg-[#C49A1E]/10 px-2.5 py-1 text-[11px] font-black uppercase tracking-wider text-[#C49A1E]">
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/[0.04] dark:bg-[#1A2416] dark:ring-white/[0.06]">
          <p className="mb-5 text-[10px] font-black uppercase tracking-[0.15em] text-[#C49A1E]">{t('detail_info')}</p>
        ...
        {station.documents.length > 0 && (
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/[0.04] dark:bg-[#1A2416] dark:ring-white/[0.06]">
            <p className="mb-5 text-[10px] font-black uppercase tracking-[0.15em] text-[#C49A1E]">{t('detail_docs')}</p>
        ...
        <div className="border-t border-[#E8E4D8] bg-white px-7 py-4 dark:border-[#1A2A14] dark:bg-[#111A0E]">
          ...
          {!showReject ? (
            ...
            <div className="space-y-3">
              <div>
                <label htmlFor="reject-reason" className="mb-1.5 block text-[11px] font-bold uppercase tracking-wider text-[#888] dark:text-[#9A9A8A]">
                ...
                <div className="mt-1 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-[#CCC] dark:text-[#A0A090]">{rejectReason.length}/{MAX_REASON}</span>
                </div>
              </div>
              <div className="flex gap-3">
...
function InfoField({ label, value, full }: { label: string; value: string; full?: boolean }) {
  return (
    <div className={full ? 'col-span-2' : ''}>
      <p className="mb-0.5 text-[10px] font-bold uppercase tracking-wider text-[#C8C4B4] dark:text-[#A0A090]">{label}</p>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <p className="text-[12px] font-bold leading-snug text-[#0F1A0C] dark:text-[#F0EDD4]">{label}</p>
      </div>
      {/* Open link */}
      <div className="flex items-center gap-1 text-[11px] font-semibold text-[#C49A1E] transition-colors group-hover:text-[#B08A10]">
        {openLabel}
  ...
  return (
    <div className="group relative flex gap-4 pb-6 last:pb-0">
      ...
      <div className="flex flex-1 flex-col gap-0.5 pt-1">
        ...
        {formattedDate && (
          <p className="text-[11px] text-[#999] dark:text-[#A0A090]">{formattedDate}</p>
        )}
        {note && (
