      ...
      <div className="fixed inset-y-0 right-0 z-50 flex w-full max-w-[420px] flex-col bg-white shadow-2xl ring-1 ring-black/[0.06] animate-fade-in-up dark:bg-[#131E10] dark:ring-white/[0.06]">
        ...
        <div className="flex flex-1 flex-col gap-4 overflow-y-auto p-6">
          ...
          <div className="rounded-2xl border border-[#E8E4DC] bg-[#F9F8F5] p-5 dark:border-[#1E2E18] dark:bg-[#0E1A0C]">
            <p className="mb-4 text-[10px] font-black uppercase tracking-widest text-[#AAAAAA] dark:text-[#4A4A3A]">{t('section_amounts')}</p>
          ...
          {/* Parties */}
          <div className="rounded-2xl border border-[#E8E4DC] bg-[#F9F8F5] p-5 dark:border-[#1E2E18] dark:bg-[#0E1A0C]">
            <p className="mb-4 text-[10px] font-black uppercase tracking-widest text-[#AAAAAA] dark:text-[#4A4A3A]">{t('section_parties')}</p>
            <div className="flex flex-col gap-3">
          ...
          {/* Stripe ID */}
          <div className="rounded-2xl border border-[#E8E4DC] bg-[#F9F8F5] p-5 dark:border-[#1E2E18] dark:bg-[#0E1A0C]">
            <p className="mb-3 text-[10px] font-black uppercase tracking-widest text-[#AAAAAA] dark:text-[#4A4A3A]">{t('drawer_stripe_id')}</p>
