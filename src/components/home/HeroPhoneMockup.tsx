...
export function HeroPhoneMockup() {
  ...
  return (
    <div className="relative">
      {/* Bubble 1 - top left */}
      <div
        className="absolute top-[-20px] left-[-64px] z-10 min-w-[160px] rounded-[10px] border border-[#FFF9EC] bg-[#FFF9EC] dark:bg-dark-bg px-4 py-3 shadow-[0_16px_40px_rgba(0,0,0,0.25)] dark:shadow-[0_16px_40px_rgba(0,0,0,0.5)] animate-float hidden lg:block"
      ...
      <div
        className="absolute bottom-[120px] right-[-56px] z-10 min-w-[160px] rounded-[10px] border border-[#FFF9EC] bg-[#FFF9EC] dark:bg-dark-bg px-4 py-3 shadow-[0_16px_40px_rgba(0,0,0,0.25)] dark:shadow-[0_16px_40px_rgba(0,0,0,0.5)] animate-float hidden lg:block"
      ...
      {/* Phone frame */}
      <div className="relative w-[264px] h-[540px] rounded-[36px] border-2 border-[rgba(221,175,59,0.28)] bg-dark-bg dark:bg-dark-bg overflow-hidden shadow-[0_0_0_8px_rgba(221,175,59,0.05),0_40px_90px_rgba(0,0,0,0.6)] animate-float">
        {/* Notch */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 z-10 h-5 w-[72px] rounded-b-[12px] bg-dark-bg dark:bg-dark-bg" />
