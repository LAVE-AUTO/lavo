        ...
        <div className="relative z-10 flex flex-col justify-center pb-12 pt-24 lg:pb-20 lg:pt-[120px] lg:pr-14">
          ...
          <div className="animate-fade-in-up animation-delay-500 flex gap-4 sm:gap-10 border-t border-[rgba(221,175,59,0.13)] pt-6">
            {[
              ...
              <div key={label}>
                <div className="font-rajdhani text-[24px] sm:text-[40px] font-bold leading-none text-[#DDAF3B] whitespace-nowrap">
                  {val}
                </div>
                <div className="font-dm-mono mt-1 text-[9px] sm:text-[11px] uppercase tracking-normal sm:tracking-[1px] leading-tight text-[var(--foreground)] dark:text-[#B0BFB1] whitespace-nowrap">
                  {label}
                </div>
              </div>
            ))}
