        ...
        <RevealOnScroll>
          <div
            className={[
              ...
              '[&_h2]:relative [&_h2]:pl-7 [&_h2]:mt-9 [&_h2]:mb-3 [&_h2]:font-playfair [&_h2]:text-[20px] sm:[&_h2]:text-[22px] [&_h2]:font-bold [&_h2]:text-[#1a1a1a] dark:[&_h2]:text-[#fef9e7]',
              '[&_h2]:before:content-[""] [&_h2]:before:absolute [&_h2]:before:left-0 [&_h2]:before:top-1/2 [&_h2]:before:-translate-y-1/2 [&_h2]:before:h-5 [&_h2]:before:w-1 [&_h2]:before:rounded-full [&_h2]:before:bg-[#c8980a]',
              '[&_h3]:mt-6 [&_h3]:mb-2 [&_h3]:text-[16px] [&_h3]:font-bold [&_h3]:text-[#1a1a1a] dark:[&_h3]:text-[#fef9e7]',
              '[&_p]:mb-4',
