...
const NOTIF_ICONS = [
  <svg key="bell" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#DDAF3B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" />
  </svg>,
  <svg key="clock" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#DDAF3B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" />
  </svg>,
  <svg key="check" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#DDAF3B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="20 6 9 17 4 12" />
  </svg>,
  <svg key="star" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#DDAF3B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
  </svg>,
];

const PHONE_ICONS = [
  <svg key="bell2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#DDAF3B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" />
  </svg>,
  <svg key="alarm" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#DDAF3B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  <svg key="card" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#DDAF3B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <RevealOnScroll>
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-[72px] items-center">
            ...
            <div>
              ...
              <p className="mb-9 text-[16px] leading-[1.75] text-[var(--foreground)] dark:text-[#B0BFB1]">
                {t('desc')}
              </p>
              ...
              <div className="flex flex-col gap-3.5">
                {features.map((feat, i) => (
                  <div
                    key={feat.title}
                    className="flex items-center gap-4 rounded-[10px] border border-[rgba(221,175,59,0.1)] bg-[rgba(245,237,214,0.03)] px-4 py-4 transition-all duration-300 hover:border-[rgba(221,175,59,0.35)] hover:bg-[rgba(221,175,59,0.05)]"
                  >
                    <div className="flex-shrink-0">{NOTIF_ICONS[i]}</div>
                    <div>
                      <div className="text-[14px] font-semibold text-[#001201] dark:text-[#FFEECA]">
                        {feat.title}
                      </div>
                      <div className="text-[12px] text-[var(--foreground)] dark:text-[#B0BFB1]">{feat.desc}</div>
                    </div>
                  </div>
                ))}
              </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {notif.hasActions && (
                        <div className="mt-2 flex gap-1.5">
                          <span className="rounded-[4px] bg-[#DDAF3B] px-2.5 py-1 text-[9px] font-bold text-[#001201]">
                            {t('btn_confirm')}
                          </span>
                      ...
                      {notif.hasStars && (
                        <div className="mt-1.5 text-[14px] text-[#DDAF3B]">★★★★★</div>
                      )}
