    ...
    <>
      <div className="flex flex-col rounded-xl border border-[#E8E4DC] bg-white shadow-sm dark:border-[#1A2A14] dark:bg-[#182214]">
        ...
        <div className="flex items-start justify-between p-4 pb-3">
          <div className="min-w-0 flex-1 pr-3">
            ...
            <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
              <span className="rounded-[5px] bg-[#F0EDE4] px-2 py-0.5 text-[10px] font-bold text-[#5A5A4A] dark:bg-[#1A2A14] dark:text-[#9A9A8A]">
        ...
        {activeEntries.length > 0 ? (
          ...
          <div className="mx-4 mb-4 rounded-[10px] border border-dashed border-[#E0DCD4] p-3 text-center text-[11px] text-[#BBBBAA] dark:border-[#243020] dark:text-[#4A4A3A]">
