...
export function DashboardDelaysPanel({ items, totalPending }: Props) {
  ...
  return (
    <div className="flex w-full max-h-[35vh] shrink-0 flex-col overflow-hidden border-b border-[#E0DCD0] bg-[#F0EDE0] md:max-h-none md:w-[280px] md:border-b-0 md:border-r dark:border-[#1A2A14] dark:bg-[#182214]">
      {/* Header */}
