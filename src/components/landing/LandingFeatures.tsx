        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {FEATURES.map((feat, i) => (
            <ScrollReveal key={feat.key} delay={i * 0.08}>
              <div className="group rounded-2xl bg-white dark:bg-dark-card border border-[#E8E8D8] dark:border-tab-inactive p-7 hover:border-gold/30 dark:hover:border-gold/20 transition-all hover:shadow-lg hover:-translate-y-0.5 h-full">
