      ...
      <div className="bg-white rounded-2xl border border-[#E0DCD0] shadow-[0_24px_64px_rgba(0,0,0,0.12)] overflow-hidden">
        ...
        <div className="border-t border-[#E0DCD0] bg-[#F7F6F2]">
          ...
          <div className="flex items-center gap-2 px-4 pt-3 pb-1">
            ...
            <span className="rounded-full bg-[#DDAF3B] px-1.5 py-0.5 text-[9px] font-black leading-tight text-[#0C1209]">3</span>
          ...
          <div className="flex gap-2 px-4 pb-4 pt-1 overflow-hidden">
            ...
            <div className="flex h-[90px] w-[72px] flex-shrink-0 flex-col items-center justify-center gap-1 rounded-2xl bg-[#DDAF3B] text-[#0C1209]">
            ...
            <div className="flex h-[90px] w-[112px] flex-shrink-0 flex-col rounded-2xl border border-[#DDAF3B] ring-1 ring-[#DDAF3B]/30 bg-white p-2">
              <div className="flex items-center justify-between gap-1">
                <span className="rounded-md bg-[#DDAF3B] px-1 py-0.5 text-[7px] font-black uppercase text-[#0C1209]">SUIVANT</span>
