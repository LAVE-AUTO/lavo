          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="hidden lg:flex items-center gap-2.5 ml-1">
              {isAuthenticated && user ? (
                <div className="w-[34px] h-[34px] rounded-full bg-[rgba(221,175,59,0.2)] border border-[rgba(221,175,59,0.4)] flex items-center justify-center shrink-0">
                  <span className="text-[13px] font-black text-[#DDAF3B] leading-none">
              ...
              {isAuthenticated && user ? (
                <div className="flex items-center gap-3 px-2 py-2">
                  <div className="w-9 h-9 rounded-full bg-[rgba(221,175,59,0.2)] border border-[rgba(221,175,59,0.4)] flex items-center justify-center shrink-0">
                    <span className="text-[14px] font-black text-[#DDAF3B] leading-none">
                      {(user.first_name?.[0] ?? user.email[0]).toUpperCase()}
                    </span>
                  </div>
                  <p className="text-[15px] font-semibold text-[#001201] dark:text-[#FFEECA]">
