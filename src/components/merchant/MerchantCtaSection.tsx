...
export function MerchantCtaSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#c8980a] px-6 py-28 lg:px-16">
      {/* Ghost text behind */}
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] text-center">
        <div className="font-dm-mono mb-5 text-[11px] uppercase tracking-[3px] text-[rgba(13,31,15,0.55)]">
          {t('eyebrow')}
        </div>
        <h2 className="font-playfair mb-5 text-[clamp(36px,5vw,60px)] font-black leading-[1.05] text-[#0d1f0f]">
          {t('title')}
        </h2>
        <p className="mx-auto mb-10 max-w-[520px] text-[17px] leading-[1.7] text-[rgba(13,31,15,0.65)]">
          {t('desc')}
        </p>
