      ...
      <div className="max-w-3xl">
        ...
        <div
          className={[
            ...
            '[&_blockquote]:border-l-4 [&_blockquote]:border-[rgba(200,152,10,0.4)] [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:my-5 [&_blockquote]:text-foreground/65 dark:[&_blockquote]:text-[#A0A090]',
